...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String projectPath ="D:\\shizhan\\parent\\frontend";
        String mapperPath=projectPath+"/src/main/resources/mapper/";
//        String tablePrefix ="dk_";
        String packageName="com.github.kotlin711.h.frontend";

        String database="h";
        final String[] tables = {"admin","video","tags","types"};
